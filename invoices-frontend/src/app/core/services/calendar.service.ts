...
export class CalendarService {
  ...
  createEvent(title: string, date: string, notes?: string, projectName?: string): Observable<CalendarEvent> {
    return this.http.post<CalendarEvent>(this.base, { title, date, notes, projectName });
  }
