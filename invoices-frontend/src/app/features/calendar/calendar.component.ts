...
export class CalendarComponent implements OnInit {
  ...
  newNotes = signal('');
  saving = signal(false);
  newEventProject = signal('');
  newEventCustomProject = signal('');
  ...
  saveEvent() {
    ...
    const resolvedProject = this.newEventProject() === '__custom__'
      ? this.newEventCustomProject().trim()
      : this.newEventProject();
    ...
    this.calendarService.createEvent(
      ...
      next: () => {
        ...
        this.showAddForm.set(false);
        this.newEventProject.set('');
        this.newEventCustomProject.set('');
